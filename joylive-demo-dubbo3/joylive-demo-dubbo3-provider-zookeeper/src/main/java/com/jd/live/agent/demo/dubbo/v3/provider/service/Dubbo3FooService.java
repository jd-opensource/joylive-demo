...
import com.jd.live.agent.demo.service.FooService;
...
@DubboService(group = "DEFAULT_GROUP", interfaceClass = FooService.class)
public class Dubbo3FooService implements FooService {
    ...
    public Dubbo3FooService(@Value("${spring.application.name}") String applicationName, EchoConfig config) {
